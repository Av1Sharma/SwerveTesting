...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        gyro = new Pigeon2(Swerve.pigeonID, Swerve.swerveCanBus);
        ...
        swerveOdometry = new SwerveDriveOdometry(Swerve.swerveKinematics, getYaw(), getModulePositions());
    ...
    public Rotation2d getYaw() {
        return (Swerve.invertGyro) ? Rotation2d.fromDegrees(360 - gyro.getYaw().getValue()) : Rotation2d.fromDegrees(gyro.getYaw().getValue());
    }
    ...
    private void configurePathPlanner() {
        AutoBuilder.configureHolonomic(
            ...
            new HolonomicPathFollowerConfig(
                ...
                new PIDConstants(Swerve.angleKP, Swerve.angleKI, Swerve.angleKD),
                Swerve.maxSpeed,
                Swerve.wheelBase / 2,
